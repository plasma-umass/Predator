...
This section describes related work in false sharing detection, prevention, or both; no previous work predicts unobserved false sharing.
...
they cannot pinpoint the exact location of false sharing in the source code, so programmers must examine the source code and identify problems manually.
