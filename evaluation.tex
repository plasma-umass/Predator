...
We have discussed that prediction helps to reveal the false sharing problems inside \texttt{linear\_regression} benchmark. In this section, we furth verify whether prediction can always identify 
...
When we eveluate detection effectiveness on its original code in Section~\ref{sec:benchmarks}, 
