...
False sharing has been found to affect different levels of software stack, including
...
Section~\ref{sec:overview} describes \defaults{}'s detection mechanisms and
