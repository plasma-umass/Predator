...
\begin{itemize}
\item
\textbf{Generic Detection Solution:}\defaults{} provides a novel false sharing detection method by
...
\item
\textbf{Practicable Detection Tool:} \defaults{} can actually detect all kinds of false sharing problems accurately and precisely 
