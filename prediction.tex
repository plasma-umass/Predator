...
\CC{A real example, \texttt{linear\_regression}, is shown in Figure~ref{fig:perfsensitive}, which are further discussed in Section~\ref{sec:evaluation}.}
For this benchmark,
...
invalidation}. 
\CC{
Before tracking detailed memory accesses on this cache line, it is impossible to know exactly how many cache invalidations happen on a virtual line.  \Predator{} conservatively assumes that accesses from different threads are interleaved.
